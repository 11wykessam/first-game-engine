...
import com.whyx.lwjgltest.engine.io.input.IMouseEnterCallbacks;
import com.whyx.lwjgltest.engine.io.input.IMouseMoveCallbacks;

/**
 * @author Samuel Wykes. Interface for a window, which can be rendered to.
 */
public interface IWindow {
  ...
  /**
   * Gets the callbacks for the mouse leaving/entering the window.
   *
   * @return {@link IMouseEnterCallbacks}.
   */
  IMouseEnterCallbacks getMouseEnterCallbacks();
  ...
  /**
   * Checks if the window should close. This is normally done by interaction outside the main game
   * loop.
   *
